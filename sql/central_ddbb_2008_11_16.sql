...
insert  into `ctrlt_segment`(`SEGMP_ID_SEGMENT`,`MAINP_ID_HOTEL`,`SRCEF_ID_SOURCE`,`SEGMC_DESCRIPTION`,`SEGMC_MADE_BY`,`SEGMC_MADE_ON`,`SEGMC_UPDATED_BY`,`SEGMC_LAST_UPDATE`,`SEGMC_STATUS`) values (1,1,1,'BANK & FINANCIAL',NULL,NULL,NULL,NULL,'*'),(2,1,2,'TOURISM & HOSTELERIA',NULL,NULL,NULL,NULL,'A'),(3,1,3,'CHEMICAL & FARMACEUTICAL',NULL,NULL,NULL,NULL,'A'),(4,1,4,'INFORMATION & TECHNOLOGY',NULL,NULL,NULL,NULL,'A');
...
CREATE TABLE `ctrlt_source_type` (
  ...
  `SRCTC_STATUS` char(1) DEFAULT NULL,
  `SRCTC_MADE_BY` char(3) DEFAULT NULL,
  `SRCTC_MADE_ON` date DEFAULT NULL,
  `SRCTC_UPDATED_BY` char(3) DEFAULT NULL,
  `SRCTC_LAST_UPDATE` date DEFAULT NULL,
  PRIMARY KEY (`SRCTP_ID_SOURCE_TYPE`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=latin1 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC;

/*Data for the table `ctrlt_source_type` */

insert  into `ctrlt_source_type`(`SRCTP_ID_SOURCE_TYPE`,`SRCTC_DESCRIPTION`,`SRCTC_ABBREVIATION`,`SRCTC_STATUS`,`SRCTC_MADE_BY`,`SRCTC_MADE_ON`,`SRCTC_UPDATED_BY`,`SRCTC_LAST_UPDATE`) values (1,'GOVERMENT','GOVERM','A','JO','2008-11-12','JO','2008-11-12'),(2,'COMPANY','COMPNY','A','JO','2008-11-12','JO','2008-11-12'),(3,'ONG','ONG','A','JO','2008-11-12','JO','2008-11-12'),(4,'TRAVEL AGENCY','AGENCY','A','JO','2008-11-12','JO','2008-11-12');
...
insert  into `ctrlt_special_rate`(`SPRTP_ID_SPECIAL_RATE`,`MAINP_ID_HOTEL`,`SPRTC_DESCRIPTION`,`SPRTC_STATUS`) values (1,1,'FULL RATE','A'),(2,1,'CONFIDENCIAL 1','A'),(3,1,'CONFIDENCIAL 2','A'),(4,1,'CONFIDENCIAL 3','A');
...
/* Procedure structure for procedure `CTRLPD_SOURCE_TYPE` */

/*!50003 DROP PROCEDURE IF EXISTS  `CTRLPD_SOURCE_TYPE` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `CTRLPD_SOURCE_TYPE`(IN p_id_source_type int )
BEGIN
...
/* Procedure structure for procedure `CTRLPI_SOURCE_TYPE` */

/*!50003 DROP PROCEDURE IF EXISTS  `CTRLPI_SOURCE_TYPE` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `CTRLPI_SOURCE_TYPE`(
...
/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `CTRLPS_SEGMENT_LIST`(IN p_id_hotel		varchar(02),
								IN p_description	varchar(20),
								IN p_status			varchar(01) )
BEGIN
...
/* Procedure structure for procedure `CTRLPS_SOURCE_TYPE` */

/*!50003 DROP PROCEDURE IF EXISTS  `CTRLPS_SOURCE_TYPE` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `CTRLPS_SOURCE_TYPE`(IN p_id_source_type int,
							   IN p_status		   varchar(01) )
BEGIN
...
/* Procedure structure for procedure `CTRLPS_SOURCE_TYPE_LIST` */

/*!50003 DROP PROCEDURE IF EXISTS  `CTRLPS_SOURCE_TYPE_LIST` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `CTRLPS_SOURCE_TYPE_LIST`(IN p_description varchar(20),
									IN p_status		 varchar(01) )
BEGIN
	DECLARE BLANK varchar(01) DEFAULT '';
	DECLARE v_description varchar(20) DEFAULT ifnull(concat(p_description,'%'),'%');
...
/* Procedure structure for procedure `CTRLPS_SPECIAL_RATE_LIST` */

/*!50003 DROP PROCEDURE IF EXISTS  `CTRLPS_SPECIAL_RATE_LIST` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `CTRLPS_SPECIAL_RATE_LIST`(
					    IN p_id_hotel	int,
...
/* Procedure structure for procedure `CTRLPU_SOURCE_TYPE` */

/*!50003 DROP PROCEDURE IF EXISTS  `CTRLPU_SOURCE_TYPE` */;

DELIMITER $$

/*!50003 CREATE DEFINER=`root`@`localhost` PROCEDURE `CTRLPU_SOURCE_TYPE`(
