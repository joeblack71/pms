 ...
 */
public class OldGenericDaoHibernate<T, K extends Serializable> implements OldGenericDao<T, K> {
    /**
     ...
     */
    public OldGenericDaoHibernate(final Class<T> persistentClass) {
     ...
     */
    public OldGenericDaoHibernate(final Class<T> persistentClass, SessionFactory sessionFactory) {
        this.persistentClass = persistentClass;
