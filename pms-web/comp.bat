...
@echo on
javac -g -Xlint -Xmaxerrs 3 -sourcepath src -classpath C:\Archiv~1\jakart~1.28\common\lib\servlet-api.jar -d C:\Archiv~1\jakarta-tomcat-5.0.28\webapps\guestbooking\WEB-INF\classes src\%1.java
