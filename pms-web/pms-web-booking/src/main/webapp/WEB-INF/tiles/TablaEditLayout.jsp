...
<head>
    ...
    <title><tiles:getAsString name="title"/> - Editar</title>
    ...
    <!--
        ...
        function saveItem() {
            var form = $('editForm');
            if (validateEditForm()) {
                if (confirm('Se actualizará el registro')) {
                    form.action = '<tiles:getAsString name="casePrefix"/>Update.do';
                    form.submit();
                }
            } else {
        ...
        function saveItemHelp() {
            return setHelp('Graba los valores');
        }
